 ...
 */
public class MenampilkanGambarComboBox extends javax.swing.JFrame {

    /**
     * Creates new form MenambahakanGambarBox
     */
    public MenampilkanGambarComboBox() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pilihanpilihCard.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pantai Batakan", "Pantai Teluk Tamiang", "Danau Sari Embun" }));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/IMG_2457.jpg"))); // NOI18N
        pCardLayout.add(jLabel2, "0");

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/IMG_5636.jpg"))); // NOI18N
        pCardLayout.add(jLabel3, "1");

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/IMG_7778.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenampilkanGambarComboBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenampilkanGambarComboBox().setVisible(true);
            }
        });
    }
